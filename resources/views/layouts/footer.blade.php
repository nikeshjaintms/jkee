                    ...
                    <div class="footer-widget contact-widget">
                        <ul class="contact-infos">
                            <li>
                                ...
                                Plot No. D-2/E/162 & 163/1, <br>
                                Nr. Suva Chokdi,
                                Vi-Galenda, <br>Ta. Vagra, Dist. Bharuch,
                                 Dahej -392 001.
                            </li>
                            <li>
                                <i class="facdori-icon-message"></i>
                                jkee.marketing@gmail.com
                            </li>
                            <li>
                                <i class="facdori-icon-phone-call-1"></i>
                                +91 63593 88988 / 95102 04043
                            </li>
                        </ul><!-- /.contact-infos -->
                    </div><!-- /.footer-widget -->
                </div><!-- /.col-lg-3 -->
        ...
        <div class="container ">
            <div class="container-inner clearfix">
                <div class="left-content float-left">
                    <p>JKEE Group  &copy; {{ date('Y') }} All Right Reserved. Design & Developed by <a href="https://techomaxsolution.com/" target="_blank" title="Techomax Solution">Techomax Solution</a></p>
